...
import { Grid, Card, Text, Button, Title, Chip, Kbd, Modal } from '@mantine/core'
    ...
    <>
      {
        helpModal && (
          ...
          >
            <Text>
              <hr/>
              <p>En esta sección se muestran las rifas, puedes filtrar por categoria y tipo.<br/></p>
              <p>
                <hr/>
                <br/><Text ta="center"><b>Tipos:</b> Normal y Especial</Text><br/>
                <b>Normal:</b> Rifas que contienen números o comodines y sus numeros de tickets no son mayor a 12.<br/><br/>
                <b>Especial:</b> Rifas que contienen números o comodines y sus numeros de tickets son mayor a 12.
              </p>
              <p>
                <Text ta="center"><b>Categorias:</b> Normal, Triples y Terminal</Text><br/>
                <b>Normal:</b> Rifas en las cuales sus numeros van desde el 100 hasta el 999.<br/><br/>
                <b>Triple:</b> Rifas en las cuales sus numeros van desde el 010 hasta el 099.<br/><br/>
                <b>Terminal:</b> Rifas en las cuales sus numeros van desde el 001 hasta el 009.
              </p>
            ...
            <Title order={2} fw={500} mb={20}>
              ...
              <Card>
                <div style={{ display: 'flex', alignItems: 'center', gap: '5px'}}>
                  <Chip color='blue' my={-10} onClick={() => setOpenFilter(!openFilter)} checked={openFilter}>{ openFilter === true ? 'Filtrar' : 'Todas'}</Chip>
                  <Kbd ml={10} mt={10}>Ctrl + M</Kbd>
                </div>
              </Card>
            </Title>
            {
