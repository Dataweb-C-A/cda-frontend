...
const permissions: PermissionMap = {
  [Role.Admin]: ['/','/rifamax' ,'/New50y50t','/Premiacion','Logint', '/users', '/riferos', '/reportes-rifa','/cuadre' ,'/x100','/reports', '/exchange', '/draws','/infinito','/reportes50y50'],
  [Role.Rifero]: ['/', '/x100', '/draws'],
